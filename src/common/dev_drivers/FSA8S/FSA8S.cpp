...
auto receiver::_recv_uart() -> void {
  _data_len = static_cast<int16_t>(uart_read_bytes(_uart_port, &_data, sizeof(_data), 0));
}

auto receiver::_get_frame_start() const -> int16_t {
