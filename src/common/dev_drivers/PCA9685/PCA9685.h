...
constexpr uint8_t PRE_SCALE_50_HZ = 0x79;
...
class pca9685 {
 private:
  ...
  //
  // The PRE_SCALE register needs to be set to 50Hz based off of the 25MHz internal oscillator
  //
  auto _set_freq() -> void;

 public:
  explicit pca9685(i2c::i2c_bus* master_bus, uint8_t addr = PCA_ADDR);
